...
const Header = ( { selectedTool, setSelectedTool, canvas, openDesmos } ) => {
  ...
  return (
    <header className='fixed top-3 left-1/2 -translate-x-1/2 w-[70vw] md:w-[50vw] p-[4.5px] px-[5.5px] rounded-lg shadow-[0px_0px_0.9310142993927002px_0px_rgba(0,_0,_0,_0.17),_0px_0px_3.1270833015441895px_0px_rgba(0,_0,_0,_0.08),_0px_7px_14px_0px_rgba(0,_0,_0,_0.05)] flex items-center justify-between z-[999]'>
